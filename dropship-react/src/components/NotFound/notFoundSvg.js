export const NotFoundSvg = () => {
    return (
        <svg viewBox="0 0 500 500">
            ...
            <g id="freepik--Robot--inject-36">
                <g id="freepik--robot--inject-36">
                    ...
                    <circle
                        ...
                        style={{ opacity: "0.25" }}
                    />
                    <circle cx="270.95" cy="302.08" r="32.34" style={{ fill: "url(#linearOne)" }} />
                    <circle
                        cx="270.95"
                        cy="302.08"
                        r="32.34"
                    ...
                    <path
                        ...
                        style={{ fill: "#37474f" }}
                    />
                    <circle cx="275.79" cy="287.53" r="1.51" style={{ fill: "url(#linearOne)" }} />
                    <circle cx="271.16" cy="289.04" r="0.74" style={{ fill: "url(#linearOne)" }} />
                    <path
                    ...
                    <path
                        ...
                        style={{ opacity: "0.25" }}
                    />
                    <circle cx="331.84" cy="249.76" r="2.57" style={{ fill: "#37474f" }} />
                    <ellipse
                        cx="251.4"
                        cy="230.74"
                        rx="37.28"
                    ...
                    <path
                        ...
                        style={{ opacity: "0.15" }}
                    />
                    <circle cx="247.94" cy="119.42" r="8.14" style={{ fill: "url(#linearOne)" }} />
                    <path
            ...
            <g id="freepik--error-404--inject-36">
                <g id="freepik--404--inject-36">
                    <g id="freepik--shadow--inject-36">
                        <path d="M171.44,82.27l3.23-1.87V74.15Z" style={{ fill: "var(--tpSec3)" }} />
                    </g>
                    <g id="freepik--404--inject-36">
                        <path
            ...
            <defs>
                ...
                >
                    <stop offset="0.15" stopColor="var(--accent)" />
