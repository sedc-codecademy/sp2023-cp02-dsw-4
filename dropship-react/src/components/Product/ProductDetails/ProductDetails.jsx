...
function ProductDetails() {
  ...
  const { // Need to do mutaiton for reviews 
    data: productData,
    error: productError,
    isError: isProdError,
  ...
  const userReview = isLoggedIn && productData ? productData.reviews.some((e) => e.authorId === userData?.id) : false
          ...
          <main className="product-page">
                ...
                <div className="paymentDiv">
                  ...
                  <div className="prices">
                    <p className="product-price">
                      <span>Price:</span> <span>${productData.price.toFixed(2)}</span>
                    </p>
                    <p className="product-shipping">
                      <span>Shipping:</span> <span>${30}</span> {/* Should make shipping dynamic */}
                    </p>
                    {productData.sale && (
            ...
            <div className="block-header">
              <div>
                ...
                <button disabled={createReview || userReview || !userData} onClick={() => setCreateReview(true)}>
