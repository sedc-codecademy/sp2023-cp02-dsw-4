export const PopularBackgroundSvg = () => {
    return (
...
export const DiscountSvg = () => {
    return (
        <svg className="discountSvg" viewBox="0 0 500 500">
            <g id="freepik--background-simple--inject-4">
                <path
                    ...
                    style={{ fill: "var(--tpPri)", opacity: "0.7000000000000001" }}
                />
            </g>
            ...
            <g id="freepik--Device--inject-4">
                ...
                />
                <path
                    d="M283.43,422.05a6.43,6.43,0,1,0-6.43,6.42A6.43,6.43,0,0,0,283.43,422.05Z"
                    style={{
                        fill: "none",
                        stroke: "#fff",
                        strokeLinecap: "round",
                ...
                />
                <path
                    d="M302.16,65.05H197.66a14.52,14.52,0,0,0-14.52,14.52v289Z"
                ...
                <rect
                    ...
                    style={{
                        ...
                        strokeLinecap: "round",
                        strokeLinejoin: "round",
                        strokeWidth: "0.8830859999999999px"
                    }}
                />
                <rect
                    x="199.54"
                ...
                />
                <polyline
                    points="340.65 172 340.65 370.02 213.43 370.02 213.43 239.23"
                    style={{
                        fill: "none",
                        stroke: "#263238",
                        strokeLinecap: "round",
                ...
                />
                <path
                    d="M212.06,276.32s-2.79,29.54-2.79,40.69-.56,18.4-.56,18.4"
                    style={{
                        fill: "var(--accent)",
                        stroke: "#263238",
                        strokeLinecap: "round",
                ...
                />
                <path
                    d="M342.5,276.88s1.12,29.54,1.12,46.82"
                    style={{
                        fill: "var(--accent)",
                        stroke: "#263238",
                        strokeLinecap: "round",
                ...
                />
                <path
                    d="M250.25,156.82l7.59-18h4.55v18h2v3.79h-2v4.82h-4.1v-4.82h-8Zm8,0v-10l-4.21,10Z"
                    style={{ fill: "#263238" }}
                />
                <path
                    ...
                    style={{ fill: "#263238" }}
                />
                <path d="M285.33,161.41v4h-4v-4Z" style={{ fill: "#263238" }} />
                <path
                ...
                />
                <path
                    d="M267.73,197.8h-2.34V174.42h3.31l5.41,16.9v-16.9h2.31V197.8h-2.71l-6-18.91Z"
                    style={{ fill: "#263238" }}
                />
                <path
                    d="M279.09,197.8V174.42h2.6v21h6.69v2.37Z"
                    style={{ fill: "#263238" }}
                />
                <path
                    d="M292.42,189.41l-4.94-15h2.7l3.64,11.49,3.68-11.49H300l-5,15v8.39h-2.57Z"
                    style={{ fill: "#263238" }}
                />
                <circle
                    cx="325.19"
                    cy="373.04"
                    r="29.85"
                    transform="translate(-142.72 534.2) rotate(-67.93)"
                    style={{ fill: "#263238" }}
                />
                <path
                ...
                />
                <path
                    d="M330.12,367.85l2.05-14h2.47L332,371h-4l-2.64-17.12h2.71Z"
                    style={{ fill: "#fff" }}
                />
                <path
                    d="M338.58,361.09h3.69v2.45h-3.69v5h4.65V371h-7.34V353.88h7.34v2.45h-4.65Z"
                    style={{ fill: "#fff" }}
                />
                <path
...
export const DiscountBackgorundSvg = () => {
    return (
        <svg id="visual" viewBox="0 0 900 450" >
            <g fill="var(--darkAccent)" stroke="var(--accent)" strokeWidth="2.3">
