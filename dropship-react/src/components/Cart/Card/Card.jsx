...
import { flipCard } from "../../../store/slices/cardSlice/cardSlice";
...
function Card() {
    ...
    const maskCardNumber = (number, mask) => {
        let maskedNumber = "";
        let j = 0;
                ...
                >
                    <g id="Front">
                      ...
                      C0,17.9,17.9,0,40,0z"
                        ...
                        >
                            {cardObject.number
                                ? getCardNumber(cardObject.number)
                                : "0123 4567 8910 1112"}
                        </text>
                        <text
