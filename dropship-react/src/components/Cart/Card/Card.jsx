...
import { CardSvg } from "./CardSvgs"
import { maskCardNumber } from "../../CardHelper/CardFunctions"
...
function Card({ cardFlipped, flipCard, card, originalCard }) {
    ...
    function getCardNumber(number) {
        ...
        return maskCardNumber(number, matchedPattern.mask)
    }

    return (
        <div
            style={{
                "--bgColor": cardType?.light,
                "--bgDarkColor": cardType?.dark,
            }}
            className={`creditCard ${cardFlipped && "flipped"}`}
            onClick={flipCard}
        >
            <div className="card front">
                <div id="ccsingle">
                    <CardSvg small={false} cardType={cardType}></CardSvg>
                </div>
                <svg
                    id="cardfront"
                    x="0px"
                      ...
                      C0,17.9,17.9,0,40,0z"
                        ...
                        >
                            {card.number
                                ...
                                : getCardNumber(originalCard.number)}
                        </text>
                        <text
                        ...
                        >
                            {card.holder || originalCard.holder}
                        </text>
                        <text
...
export function NewCard({ cardFlipped, flipCard, card }) {
                    ...
                    <g id="Front">
                      ...
                      C0,17.9,17.9,0,40,0z"
                        ...
                        >
                            {card.number
                                ? getCardNumber(card.number)
                                : getCardNumber("1234 4567 8910 1112")}
                        </text>
                        <text
                            transform="matrix(1 0 0 1 54.1064 428.1723)"
                            id="svgname"
