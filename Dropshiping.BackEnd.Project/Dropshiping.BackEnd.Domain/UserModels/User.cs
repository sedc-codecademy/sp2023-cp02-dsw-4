...
namespace Dropshiping.BackEnd.Domain.UserModels
{
    public class User : BaseEntity
    {
        ...
        public virtual ICollection<Rating> Ratings { get; set; } // Kako ova? so e klasata raitings i kako da se izveda za da se smetnuva samoto? bez dodaten kod zoso vleche property on creat
